...
public class SPHSystem : JobComponentSystem
{
    ...
    {
        // Get the colliders
        colliders = SPHColliderGroup.ToComponentDataArrayAsync<SPHCollider>(Allocator.Persistent, out collidersToNativeArrayJobHandle);
    }
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        for (int typeIndex = 1; typeIndex < uniqueTypes.Count; typeIndex++)
        {
            ...
            NativeArray<Translation> particlesPosition = SPHCharacterGroup.ToComponentDataArrayAsync<Translation>(Allocator.TempJob, out particlesPositionJobHandle);
            JobHandle particlesVelocityJobHandle;
            NativeArray<SPHVelocity> particlesVelocity = SPHCharacterGroup.ToComponentDataArrayAsync<SPHVelocity>(Allocator.TempJob, out particlesVelocityJobHandle);
